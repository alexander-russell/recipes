...
\end{enumerate}
\newpage
\phantomsection\label{rec:Lentil Burgers}
\subsection*{\center\huge Lentil Burgers}\index{Lentil Burgers}\index[prop]{\textbf{Vegetarian}!Lentil Burgers}\index[prop]{\textbf{Untested}!Lentil Burgers}
\begin{description}
...
From \href{https://www.healthylittlefoodies.com/lentil-burgers/#Lentil_Burgers}{Healthy Little Foodies} (some health website) but with more spices, more eggs, more breadcrumbs and less sweet potato. \hfill\color{accent}{\Large\hyperref[fig:Lentil Burgers]{\faCameraRetro}\hspace{0.1cm}\faVimeoSquare\hspace{0.1cm}\faTruck\hspace{0.1cm}\href{https://www.healthylittlefoodies.com/lentil-burgers/#Lentil_Burgers}{\faLink}\hspace{0.1cm}}\color{black}
...
\label{cat:Kebabs}
\phantomsection\label{rec:Beef Burritos}
\subsection*{\center\huge Beef Burritos}\index{Beef Burritos}\index[prop]{\textbf{Untested}!Beef Burritos}\index[cuisine]{\textbf{Mexican}!Beef Burritos}
\begin{description}
...
A common sense recipe, roughly what we did at Dads. The brown rice makes an enormous difference. \hfill\color{accent}{\Large\hyperref[fig:Beef Burritos]{\faCameraRetro}\hspace{0.1cm}\faTruck\hspace{0.1cm}}\color{black}
...
\end{enumerate}
\newpage
\phantomsection\label{rec:my recipe}
\subsection*{\center\huge my recipe}\index{my recipe}\index[prop]{\textbf{Vegetarian}!my recipe}\index[prop]{\textbf{Vegan}!my recipe}\index[cuisine]{\textbf{Italian}!my recipe}
\begin{description}
\item[Makes:] 4 beefs
\item[Cost:] \textdollar
...
\end{enumerate}
\newpage
\phantomsection\label{rec:Spaghetti And Meatballs}
\subsection*{\center\huge Spaghetti And Meatballs}\index{Spaghetti And Meatballs}\index[prop]{\textbf{Untested}!Spaghetti And Meatballs}\index[cuisine]{\textbf{Italian}!Spaghetti And Meatballs}
\begin{description}
\item[Makes:] 5 serves
\item[Cost:] \textdollar
\item[Time:] 70 minutes
...
With advice from Lorenzo. Rolling the meatballs in flour stops them breaking apart and makes them crispier. \hfill\color{accent}{\Large\hyperref[fig:Spaghetti And Meatballs]{\faCameraRetro}\hspace{0.1cm}\faTruck\hspace{0.1cm}}\color{black}
...
\begin{multicols}{2}
\begin{itemize}
 \item Beef mince (70% pork) \hfill 500 grams
...
\end{figure}
\newpage\begin{figure}[H]
\begin{center}\hyperref[rec:White bread (crusty, no-knead)]{\includegraphics[keepaspectratio,width=\textwidth,height=\textheight]{Gallery/White bread (crusty, no-knead)}}\caption*{}\label{fig:White bread (crusty, no-knead)}\end{center}
\end{figure}
\newpage\begin{figure}[H]
...
\end{figure}
\newpage\begin{figure}[H]
\begin{center}\hyperref[rec:Apple Cinnamon Muffins]{\includegraphics[keepaspectratio,width=\textwidth,height=\textheight]{Gallery/Apple Cinnamon Muffins}}\caption*{}\label{fig:Apple Cinnamon Muffins}\end{center}
\end{figure}
\newpage\begin{figure}[H]
...
\end{figure}
\newpage\begin{figure}[H]
\begin{center}\hyperref[rec:Enchiladas]{\includegraphics[keepaspectratio,width=\textwidth,height=\textheight]{Gallery/Enchiladas}}\caption*{}\label{fig:Enchiladas}\end{center}
\end{figure}
\newpage\begin{figure}[H]
\begin{center}\hyperref[rec:Lasagne]{\includegraphics[keepaspectratio,width=\textwidth,height=\textheight]{Gallery/Lasagne}}\caption*{}\label{fig:Lasagne}\end{center}
\end{figure}
\newpage\begin{figure}[H]
\begin{center}\hyperref[rec:Nachos]{\includegraphics[keepaspectratio,width=\textwidth,height=\textheight]{Gallery/Nachos}}\caption*{}\label{fig:Nachos}\end{center}
\end{figure}
\newpage\begin{figure}[H]
\begin{center}\hyperref[rec:Tuna Pasta Bake]{\includegraphics[keepaspectratio,width=\textwidth,height=\textheight]{Gallery/Tuna Pasta Bake}}\caption*{}\label{fig:Tuna Pasta Bake}\end{center}
\end{figure}
\newpage\begin{figure}[H]
...
\end{figure}
\newpage\begin{figure}[H]
\begin{center}\hyperref[rec:Gyros]{\includegraphics[keepaspectratio,width=\textwidth,height=\textheight]{Gallery/Gyros}}\caption*{}\label{fig:Gyros}\end{center}
\end{figure}
\newpage\begin{figure}[H]
\begin{center}\hyperref[rec:Chow Mein]{\includegraphics[keepaspectratio,width=\textwidth,height=\textheight]{Gallery/Chow Mein}}\caption*{}\label{fig:Chow Mein}\end{center}
\end{figure}
\newpage\begin{figure}[H]
...
\end{figure}
\newpage\begin{figure}[H]
\begin{center}\hyperref[rec:Pad See Ew]{\includegraphics[keepaspectratio,width=\textwidth,height=\textheight]{Gallery/Pad See Ew}}\caption*{}\label{fig:Pad See Ew}\end{center}
\end{figure}
\newpage\begin{figure}[H]
\begin{center}\hyperref[rec:Basil Chicken Pesto]{\includegraphics[keepaspectratio,width=\textwidth,height=\textheight]{Gallery/Basil Chicken Pesto}}\caption*{}\label{fig:Basil Chicken Pesto}\end{center}
\end{figure}
\newpage\begin{figure}[H]
...
\end{figure}
\newpage\begin{figure}[H]
\begin{center}\hyperref[rec:Pumpkin Quiche]{\includegraphics[keepaspectratio,width=\textwidth,height=\textheight]{Gallery/Pumpkin Quiche}}\caption*{}\label{fig:Pumpkin Quiche}\end{center}
\end{figure}
\newpage\begin{figure}[H]
...
\end{figure}
\newpage\begin{figure}[H]
\begin{center}\hyperref[rec:Chicken Caesar Salad]{\includegraphics[keepaspectratio,width=\textwidth,height=\textheight]{Gallery/Chicken Caesar Salad}}\caption*{}\label{fig:Chicken Caesar Salad}\end{center}
\end{figure}
\newpage\begin{figure}[H]
\begin{center}\hyperref[rec:Chicken Fatteh]{\includegraphics[keepaspectratio,width=\textwidth,height=\textheight]{Gallery/Chicken Fatteh}}\caption*{}\label{fig:Chicken Fatteh}\end{center}
\end{figure}
\newpage\begin{figure}[H]
